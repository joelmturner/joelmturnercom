...
tags:
  - React
  - React hooks
description: React useDims hook that returns width, height, top, and left of a DOM element. Uses useLayoutEffect and getBBox for SVG. Handy for layout and measurement.
cover: Posts/useDims
relatedPosts:
