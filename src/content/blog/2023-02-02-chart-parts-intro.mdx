...
description: How chart parts fit together when building charts and chart libraries. Quick overview of scales, axes, and primitives so you can compose or build your own chart lib.
