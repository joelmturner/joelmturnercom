---
title: "Chart Parts: Dimensions, Metrics, and What Makes Up a Chart"
description: "Understand dimensions vs metrics, then how field, legend, axes, and controls fit together in any chart. Intro anatomy with diagram and video—before you build or pick chart types."
...
series: Chart Parts
relatedPosts:
  - data-vis-react-bar-chart-vx
  - create-a-single-line-chart-in-react-with-@vx
cover: Posts/anatomy_of_a_chart
slug: chart-parts-anatomy-of-a-chart
video:
  youtubeId: jU5UbejrBhc
---

import { YouTube } from "astro-embed";

<YouTube id="jU5UbejrBhc" />
...
<CodeSandbox
  title="React Single and Stacked Bar Chart with @visx"
  id="0ieqrf"
/>
...
When we use the right chart for the data and leverage the parts that make up a chart, we can tell a better story with our data. Ready to build? Start with a [bar chart in React with @vx](/blog/data-vis-react-bar-chart-vx/) or a [single line chart with @vx](/blog/create-a-single-line-chart-in-react-with-@vx/).
