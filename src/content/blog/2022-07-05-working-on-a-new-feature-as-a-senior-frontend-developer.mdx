...
description: Senior frontend guide for new feature tickets: scope with design and API, reuse patterns, define "done," and know when to refactor. Questions to ask before writing code.
...
cover: Posts/new_feature_ticket
---
...
<div class="flex items-center flex-col max-w-350px m-0 auto">
  <div
    style={{
      width: "100%",
      height: 0,
  ...
  <p>
    <a href="https://giphy.com/gifs/spotify-play-streaming-3krrjoL0vHRaWqwU3k">
      via GIPHY
    </a>
  </p>
</div>
