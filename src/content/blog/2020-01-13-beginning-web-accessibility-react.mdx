...
tags:
  ...
  - a11y
  - accessibility
description: Getting started with web accessibility in React. Add eslint-plugin-jsx-a11y, learn WAI-ARIA roles and semantics, and try no-mouse-days to find gaps.
cover: Posts/a11y
relatedPosts:
