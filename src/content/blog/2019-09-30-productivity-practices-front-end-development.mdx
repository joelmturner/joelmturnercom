...
seriesOrder: 0
relatedPosts:
  - front-end-ticket-checklist
description: "Productivity practices for front-end dev: window management with Better Touch Tool, Spaces for app grouping, and systems that help ship without burning out."
cover: Posts/productivity-practices-for-front-end-development
