---
title: "Astro Font Loading: Optimizing Performance with astro-font"
date: 2024-02-04T18:43:03.477Z
lastmod: 2025-12-19T18:43:03.476Z
type: blog
slug: astro-font-optimization
description: Optimize font loading in Astro with the Astro Font package. Preload fonts, control font-display, and reduce layout shift (CLS) for better Core Web Vitals.
tags:
  - Astro
  - optimization
  - fonts
...
> **NOTE:** There is a built-in way of handling fonts in Astro using the configuration in `astro.config`. See the [Astro Font Loading](/blog/astro-font-loading/) blog post for more information.
