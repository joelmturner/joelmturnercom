---
title: Opinionated Flexbox and Grid Components for React
description: Opinionated Flex and Grid wrappers for React layouts—boolean alignment props, gap support, and simple grid templates. Props reference, usage examples, and CodeSandbox.
