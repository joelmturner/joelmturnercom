...
description: Reusable React layout components built with flexbox and CSS Grid. Use as building blocks for rapid layout—pass down via MdxProvider and extend with styled-components or sx.
