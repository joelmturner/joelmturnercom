...
description: Build an inline editable text input with React Hooks. Click to edit, Enter to save, Esc to cancel. Step-by-step tutorial with working CodeSandbox example.
featured: true
relatedPosts:
...
A nice feature in many apps is to edit a title or other text inline without leaving the context that we're in. This component composes with [reusable React layout components](/blog/react-layout-components/) (Flexbox and CSS Grid) for alignment and spacing.
