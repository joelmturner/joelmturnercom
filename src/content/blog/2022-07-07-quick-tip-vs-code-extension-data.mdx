...
description: By relocating the folders that are created/updated by VS Code Extensions we
...
tags:
  ...
  - quick tip
category: dev
lastmod: 2022-07-08T07:04:25.240Z
excerpt: By relocating the folders that are created/updated by VS Code Extensions we
  can bypass the need to update a gitignore file.
cover: https://res.cloudinary.com/joelmturner/image/upload/v1657262681/Posts/vs_code_extension_folder_location.jpg
