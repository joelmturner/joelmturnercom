...
description: Quick tip: move VS Code extension data folders (e.g. Local History) into .vscode so you don't have to add them to .gitignore. Keeps workspace clean for the team.
...
cover: Posts/vs_code_extension_folder_location
