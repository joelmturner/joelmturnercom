---
title: "Migrating from Next.js to Astro: Svelte Islands & Panda CSS"
...
I'll post updates along to way. If you'd like to follow along, you can follow on [X/Twitter](https://twitter.com/joelmturner) or grab the [RSS feed](/rss.xml).
