---
title: "Why I Migrated from Next.js to Astro (Svelte Islands & Panda CSS)"
date: 2023-12-29T20:13:34.472Z
lastmod: 2023-12-29T20:13:34.470Z
type: blog
slug: nextjs-astro
description: Converting my site from Next.js to Astro and Svelte, styled with Panda CSS. Notes on the migration, what stayed, and what changed for a faster, simpler stack.
tags:
  - Astro
  - panda css
  - Svelte
...
I later [optimized font loading](/blog/astro-font-loading/) which helped the site load even faster.
...
I'll post updates along to way. If you'd like to follow along, you can follow on [X/Twitter](https://twitter.com/joelmturner) or grab the [RSS feed](http://joelmturner.com/rss.xml).
