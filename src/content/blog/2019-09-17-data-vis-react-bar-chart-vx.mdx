...
description: Build a bar chart in React with @vx (visx) charting primitives. Step-by-step with scales, bars, and axes. Includes CodeSandbox and a base for more chart types.
...
If chart anatomy is new, read [Chart Parts: dimensions, metrics, and what makes up a chart](/blog/chart-parts-anatomy-of-a-chart/) first—it covers dimensions, metrics, axes, and controls before you write code.
