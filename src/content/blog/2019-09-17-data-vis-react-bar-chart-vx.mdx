...
order: 0
lastmod: 2023-01-12T16:52:16.842Z
excerpt: Building a bar chart in React using the @vx library of charting primitives.
  This is one of the most widely used charts and gives a good base for building
  upon.
cover: https://res.cloudinary.com/joelmturner/image/upload/v1655157939/Posts/vx-bar-chart.jpg
---
