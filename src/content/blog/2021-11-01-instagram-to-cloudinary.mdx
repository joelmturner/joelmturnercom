...
tags:
  ...
  - TypeScript
  - Cloudinary
lastmod: 2023-02-08T07:35:01.776Z
...
_Update: January 2023_ - Shortly after posting this article, I moved my site from [Gatsby](https://www.gatsbyjs.com/) to [Nextjs](https://nextjs.org/). You can see how I retrieve the images in the [Retrieving Cloudinary Images](#retrieving-cloudinary-images) section.
