...
order: 1
lastmod: 2022-06-13T22:44:17.632Z
excerpt: This is a simple example of a single line chart built with the @vx charting
  primitives. We can use this to as a base to add multiple lines to our chart.
cover: https://res.cloudinary.com/joelmturner/image/upload/v1655157939/Posts/vx-line-chart.jpg
---
