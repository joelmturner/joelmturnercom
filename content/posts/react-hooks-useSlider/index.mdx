...
cover: "./react-hooks-useslider.png"
category: dev
tags: 
  - React
  - React hooks
...
<!-- TODO: double check useInterval post -->
...
<Embed source="codeSandbox" id="simple-react-hooks-interval-slider-vsmi1" title='Simple React Hooks Slider' height='500px' />
